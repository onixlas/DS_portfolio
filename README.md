...
* подготовлен модуль для анализа содержимого отсканированных документов, количество классов увеличено до 19, mAP@.5 улучшен с .89 до .94
* реализован поиск чувствительных данных в текстовых файлах
* собраны и размечены 8 датасетов для задач классификации и object detection
